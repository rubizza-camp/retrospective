...
RSpec.describe ActionItemPolicy do
  ...
  context '#move?' do
    it 'returns true if user is a member of board' do
      expect(creator_policy.apply(:move?)).to eq true
    end
